...
export default function BlogIndex() {
  const articles = [
    ...
    { title: "Post-Surgical Rehabilitation", desc: "Comprehensive recovery protocols for joint replacements, ligament repairs, and orthopedic surgeries.", href: "/blog/post-surgical-rehab", category: "Physiotherapy", icon: Activity, colorClass: "text-primary bg-primary/10", borderHover: "hover:border-primary/50" },
    { title: "Ergonomics & Desk Posture", desc: "Combatting poor desk posture, tech neck, and repetitive strain injuries in the corporate world.", href: "/blog/ergonomics-desk-posture", category: "Physiotherapy", icon: Activity, colorClass: "text-primary bg-primary/10", borderHover: "hover:border-primary/50" },
    { title: "Plantar Fasciitis Relief", desc: "Clinical approaches to resolving chronic heel pain and arch collapse.", href: "/blog/plantar-fasciitis-relief", category: "Physiotherapy", icon: Activity, colorClass: "text-primary bg-primary/10", borderHover: "hover:border-primary/50" },
    { title: "Tennis Elbow & Carpal Tunnel", desc: "Treating repetitive strain injuries of the elbow, wrist, and hand.", href: "/blog/tennis-elbow-carpal-tunnel", category: "Physiotherapy", icon: Activity, colorClass: "text-primary bg-primary/10", borderHover: "hover:border-primary/50" },
      ...
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground leading-relaxed font-light">
            Explore our comprehensive library of 15 deep-dive articles covering advanced physiotherapy, clinical nutrition, and mental health strategies.
          </p>
        </motion.div>
